...
public class Server {
    ...
    private SynapseAPI synapse = null;
    ...
    public Server(MainLogger logger, final String filePath, String dataPath, String pluginPath) {
        ...
        if(((int) this.getAdvancedProperty("server.gc-period", 36000)) > 0){
            int period = (int) this.getAdvancedProperty("server.gc-period", 36000);
            this.scheduler.scheduleRepeatingTask(new Runnable(){
                @Override
                public void run(){
                    doGarbationCollector();
                }
            }, period);
        }
        ...
        if((boolean) this.getAdvancedConfig("synapse.enable")){
            this.synapse = new SynapseAPI(this);
        }
    ...
    public void doGarbationCollector(){
        doGarbationCollector(null);
    }

    public void doGarbationCollector(CommandSender sender){
        this.scheduler.scheduleAsyncTask(new GarbageCollectorTask(sender));
    }
    ...
    public Config getAdvancedConfig() {
    ...
    public Object getAdvancedConfig(String variable) {
        return getAdvancedConfig(variable, null);
    }

    public Object getAdvancedConfig(String variable, Object defaultValue) {
        Object value = this.advancedConfig.get(variable);
        return value == null ? defaultValue : value;
    }

    public Object getAdvancedProperty(String variable) {
        return getAdvancedProperty(variable, null);
    }
